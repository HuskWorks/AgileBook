...
public class DB
{
  ...
  {
    /*
     * You need to set up MySQL as follows:
     * mysql> CREATE DATABASE ShoppingCart;
     * mysql> USE ShoppingCart;
     * mysql> CREATE TABLE Items (orderId int, quantity int, sku VARCHAR(40));
     * mysql> CREATE TABLE Orders (orderId int, cusid VARCHAR(40));
     * mysql> CREATE TABLE Products (sku VARCHAR(40), name VARCHAR(40), price int);
     * mysql> GRANT ALL ON ShoppingCart.* TO 'yourId'@'localhost';
     */
    Class.forName("com.mysql.jdbc.Driver"); // load driver
    con = DriverManager.getConnection("jdbc:mysql://localhost/ShoppingCart","yourId","your_pwd");
  }
  ...
  {
    LinkedList<ItemData> l = new LinkedList<ItemData>();
